  ...
  <div class="container mt-0">
    <div class="row align-items-center justify-content-center">
      <div class="col-xl-7 col-md-6 sign text-center">
        <div>
          <img src="{{ asset('assets/images/food-image.jpg') }}" class="food-img" alt="">
        </div>
      </div>
        ...
        <div class="sign-in-your">
              ...
              <div class="row align-items-center justify-content-between mt-4 mb-2">
                <div class="mb-3">
                  <div class="form-check custom-checkbox ms-1">
                    ...
                    <label class="form-check-label" for="basic_checkbox_1">Kebijakan Privasi</label>
                  </div>
                </div>
                <div class="mb-3 text-end align-self-center">
          ...
          <div style="display: flex;">
            <div class="card" style="width: 18rem; margin-right: 20px;">
              <a href="{{ route('register.penyedia') }}"> <!-- Menggunakan route untuk halaman registrasi layanan jasa -->
            ...
            <div class="card" style="width: 18rem; margin-right: 20px;">
              <a href="{{ route('register.user') }}"> <!-- Menggunakan URL langsung untuk halaman registrasi pengguna -->
                <div class="card-body" style="text-align: center;">
                  <img src="{{ asset('assets/images/penyedia.png') }}" class="card-img-top" alt="...">
