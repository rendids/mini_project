...
.eye-button .fa-eye {
    color: blue; /* Warna biru untuk icon mata */
...
.eye-button .sub-bx {
    ...
    width: 10px; /* Sesuaikan ukuran sub-box sesuai kebutuhan */
    height: 10px;
    background-color: blue; /* Warna biru untuk sub-box */
    border-radius: 50%;
    display: none; /* Sembunyikan sub-box secara default */
}
                        ...
                        <table class="table table-list i-table style-1 mb-4 border-0" id="guestTable-all3">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-bx d-flex py-3  align-items-center">
                                            <img class="me-3 rounded-circle" src="public/assets/images/popular-img/review-img/pic-1.jpg" alt="images">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-bx d-flex py-3  align-items-center">
                                            <img class="me-3 rounded-circle" src="public/assets/images/popular-img/pic-2.jpg" alt="images">
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="media-bx d-flex py-3  align-items-center">
                                            <img class="me-3 rounded-circle" src="public/assets/images/popular-img/review-img/pic-2.jpg" alt="images">
                                            <div>
                                ...
                                <tr class="dlab-table-bottom-line">
                                    ...
                                    <td>
                                        <div class="media-bx d-flex py-3  align-items-center">
                                            <img class="me-3 rounded-circle" src="public/assets/images/popular-img/review-img/pic-3.jpg" alt="images">
                                            <div>
                        ...
                        <div class="card-footer border-0 pt-2">
                            <div class="common d-flex align-items-center justify-content-between">
                                ...
                                <div class="eye-button">
                                    <div class="fa fa-eye" style="margin: 5px;"></div>
