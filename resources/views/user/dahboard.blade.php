...
<div class="container">
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <ul class="grid-tab nav nav-pills" id="list-tab" role="tablist">
            ...
            <button class="nav-link me-3" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-list" type="button" role="tab" aria-controls="pills-list" aria-selected="false" tabindex="-1">
                    ...
                    <div class="card dishe-bx b-hover style-1">
                        ...
                        <div class="card-body pb-0 pt-3">
                            <div class="text-center mb-2">
                                <img src="public/assets/images/popular-img/pic-3.jpg" alt="">
                            </div>
